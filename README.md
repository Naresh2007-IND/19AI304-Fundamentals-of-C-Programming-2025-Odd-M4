...
/* User-defined function with parameters and no return value */
...
/* Function to convert special characters to uppercase */
void convertString(char str[]) {
    ...
    /* Convert character before and after each space */
